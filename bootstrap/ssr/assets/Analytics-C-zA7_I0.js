  ...
  return /* @__PURE__ */ jsx(DashboardLayout, { children: /* @__PURE__ */ jsxs("div", { className: "user-dashboard", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "reviewer-analytics-grid", children: [
      /* @__PURE__ */ jsxs("section", { className: "user-studies-section", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "user-analytics-chart-card", children: /* @__PURE__ */ jsx("div", { className: "user-analytics-chart user-analytics-chart--small", children: /* @__PURE__ */ jsx("canvas", { ref: decisionChartRef }) }) })
      ] }),
      /* @__PURE__ */ jsxs("section", { className: "user-studies-section", children: [
        /* @__PURE__ */ jsx("div", { className: "user-studies-heading", children: /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("div", { className: "dashboard-eyebrow", children: "REVIEW ACTIVITY" }),
          /* @__PURE__ */ jsx("h2", { children: "Aktivitas Review" }),
          /* @__PURE__ */ jsx("p", { children: "Jumlah kajian yang kamu proses dalam 7 hari terakhir." })
        ] }) }),
        ...
        return /* @__PURE__ */ jsx(
          "article",
          {
            ...
            children: /* @__PURE__ */ jsxs("div", { className: "user-study-card__content", children: [
              /* @__PURE__ */ jsx("div", { className: "user-study-card__status", children: review.decision === "revision" ? "Revision" : review.decision === "approved" ? "Forwarded" : "Rejected" }),
