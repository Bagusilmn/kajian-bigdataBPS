...
function Analytics({
  ...
  return /* @__PURE__ */ jsx(DashboardLayout, { children: /* @__PURE__ */ jsxs("div", { className: "user-dashboard", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "dashboard-stats", children: [
      /* @__PURE__ */ jsxs("div", { className: "director-analytics-stat", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "director-analytics-grid", children: [
      /* @__PURE__ */ jsxs("section", { className: "director-analytics-section", children: [
        /* @__PURE__ */ jsx("div", { className: "director-analytics-heading", children: /* @__PURE__ */ jsxs("div", { children: [
        ...
        return /* @__PURE__ */ jsx(
          "article",
          {
            ...
            children: /* @__PURE__ */ jsxs("div", { className: "user-study-card__content", children: [
              /* @__PURE__ */ jsx("span", { className: "director-history-card__status", children: review.stage === "director" ? review.decision === "approved" ? "Approved" : review.decision === "revision" ? "Revision" : "Rejected" : "Review" }),
