...
function Dashboard({
  ...
  return /* @__PURE__ */ jsx(DashboardLayout, { children: /* @__PURE__ */ jsxs("div", { className: "user-dashboard", children: [
    ...
    /* @__PURE__ */ jsxs("section", { className: "user-studies-section", children: [
      ...
      directorStudies.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "studies-empty", children: [
        /* @__PURE__ */ jsx("h2", { children: "Tidak ada kajian" }),
        /* @__PURE__ */ jsx("p", { children: "Belum ada kajian yang menunggu review final." })
      ] }) : /* @__PURE__ */ jsx("div", { className: "user-study-grid", children: directorStudies.map((study) => {
        var _a, _b;
          ...
          "a",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "user-study-card__content", children: [
                /* @__PURE__ */ jsx("span", { className: "user-study-card__status", children: "Review Final" }),
                ...
                /* @__PURE__ */ jsxs("div", { className: "user-study-card__footer", children: [
                  ...
                  /* @__PURE__ */ jsx("span", { className: "user-study-link", children: "Review →" })
                ] })
              ] })
            ]
          },
