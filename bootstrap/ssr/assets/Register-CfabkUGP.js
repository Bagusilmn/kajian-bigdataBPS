...
function Register() {
  ...
  return /* @__PURE__ */ jsx("main", { className: "auth-page-react", children: /* @__PURE__ */ jsxs("div", { className: "auth-container-react", children: [
    /* @__PURE__ */ jsxs("div", { className: "auth-header-react", children: [
      ...
      /* @__PURE__ */ jsx("h1", { children: "Buat Akun" }),
      /* @__PURE__ */ jsx("p", { children: "Daftar untuk mengakses platform Kajian Big Data BPS" })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "auth-card-react", children: [
      /* @__PURE__ */ jsxs("form", { onSubmit: submit, children: [
        /* @__PURE__ */ jsxs("div", { className: "auth-field-react", children: [
          ...
          form.errors.name && /* @__PURE__ */ jsx("div", { className: "auth-error", children: form.errors.name })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "auth-field-react", children: [
        ...
        /* @__PURE__ */ jsx(
          "button",
          {
            ...
            children: form.processing ? "Mendaftarkan..." : "Daftar"
          }
        )
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "auth-footer-react", children: [
        /* @__PURE__ */ jsx("span", { children: "Sudah memiliki akun?" }),
        /* @__PURE__ */ jsx(
          "a",
          {
            href: "/login",
