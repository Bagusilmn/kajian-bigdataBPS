...
function StudyReview({ study }) {
  ...
  const approve = () => {
    openConfirm({
      ...
      message: "Kajian ini akan diterbitkan dan dapat dilihat oleh publik.",
  ...
  const reject = () => {
    openConfirm({
      title: "Tolak Kajian?",
      message: "Kajian ini akan ditolak dari proses publikasi.",
  ...
  return /* @__PURE__ */ jsx(DashboardLayout, { children: /* @__PURE__ */ jsxs("div", { className: "review-page", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "review-header", children: /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("div", { className: "dashboard-eyebrow", children: "REVIEW FINAL" }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "review-meta", children: [
        ...
        /* @__PURE__ */ jsx("span", { children: "•" }),
        /* @__PURE__ */ jsx("span", { className: "review-status", children: (_c = study.status) == null ? void 0 : _c.replaceAll("_", " ") })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxs("div", { className: "review-layout", children: [
      ...
      /* @__PURE__ */ jsx("aside", { className: "review-panel", children: study.status === "director_review" && /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsxs("div", { className: "review-action-card", children: [
          /* @__PURE__ */ jsx("div", { className: "dashboard-eyebrow", children: "KEPUTUSAN FINAL" }),
          /* @__PURE__ */ jsx("h2", { children: "Review Direktur" }),
          /* @__PURE__ */ jsx("p", { children: "Tentukan keputusan akhir terhadap kajian ini." }),
